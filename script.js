...
function setupEventListeners() {
    ...
    // Message form
    safeAddEventListener('messageForm', 'submit', (e) => {
        e.preventDefault();
        sendMessage(e);
    });
    ...
    // Call buttons
    safeAddEventListener('voiceCallBtn', 'click', () => {
        console.log('Voice call button clicked');
        startCall('audio');
    });
    
    safeAddEventListener('videoCallBtn', 'click', () => {
        console.log('Video call button clicked');
        startCall('video');
    });
    
    safeAddEventListener('screenShareBtn', 'click', () => {
        console.log('Screen share button clicked');
        toggleScreenShare();
    });
    
    // Call controls
    safeAddEventListener('endCallBtn', 'click', endCall);
    safeAddEventListener('hangupBtn', 'click', endCall);
    safeAddEventListener('muteBtn', 'click', toggleMute);
    safeAddEventListener('videoBtn', 'click', toggleVideo);
    
    // Friends
    safeAddEventListener('addFriendBtn', 'click', () => {
    ...
    safeAddEventListener('closeAddFriendModal', 'click', () => {
        const modal = document.getElementById('addFriendModal');
        const input = document.getElementById('searchUserInput');
    ...
    safeAddEventListener('closeFriendsBtn', 'click', () => {
        const friendsSection = document.getElementById('friendsSection');
        const onlineUsers = document.getElementById('onlineUsers');
        if (friendsSection) friendsSection.style.display = 'none';
        if (onlineUsers) onlineUsers.style.display = 'block';
    });
